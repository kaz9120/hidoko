		...
		<footer className="border-t border-border-subtle bg-bg-0 px-[var(--ykz-pad)] pt-14 pb-12">
			<div className="mx-auto grid max-w-[1080px] grid-cols-1 items-start gap-10 min-[880px]:grid-cols-[auto_1fr]">
				...
				<Button
					asChild
					variant="outline"
					className="self-center bg-secondary hover:border-[color-mix(in_oklab,var(--brand)_50%,var(--border))] hover:bg-secondary hover:text-primary min-[880px]:justify-self-end"
				>
