			...
			<main className="grid min-h-dvh place-items-center bg-[var(--bg)] px-6 py-12 text-[var(--text)]">
				<div className="w-full max-w-[420px] text-center">
					...
					<div className="mt-6">
						<Link
							to="/signin"
							className="font-medium text-[13px] text-[var(--ember-400)] hover:text-[var(--ember-300)]"
						>
							サインインへ →
						</Link>
					</div>
		...
		<main className="relative grid min-h-dvh place-items-center bg-[var(--bg)] px-6 py-12 text-[var(--text)]">
			...
			<div className="w-full max-w-[380px] text-center">
				<div className="relative mx-auto mb-5 size-14">
					...
					<div className="hidoko-id-spin absolute inset-0 rounded-full border-2 border-transparent border-t-[var(--ember-400)] border-r-[var(--ember-400)]" />
					<div className="absolute inset-0 grid place-items-center">
						<Flame
							aria-hidden
							className="hidoko-id-pulse size-5 text-[var(--ember-400)]"
						/>
					</div>
				</div>
