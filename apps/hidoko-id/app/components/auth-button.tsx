			...
			<Button
				...
				className={cn(
					...
					variant === "primary" && [
						...
						"bg-[linear-gradient(180deg,var(--brand-hover)_0%,var(--brand-active)_100%)]",
						"shadow-[0_1px_0_rgba(0,0,0,0.4),0_6px_20px_rgba(244,125,58,0.35),inset_0_1px_0_rgba(255,240,220,0.35)]",
						"hover:border-[var(--brand-active)]",
						"hover:bg-[linear-gradient(180deg,var(--ember-200)_0%,var(--brand)_100%)]",
						"focus-visible:shadow-[var(--glow-ember-strong)] focus-visible:ring-0",
					],
					variant === "secondary" && [
						"border-[var(--border-strong)] bg-[var(--bg-overlay)] text-[var(--text)]",
						"hover:border-[color-mix(in_oklab,var(--brand)_32%,var(--border-strong))]",
